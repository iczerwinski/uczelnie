...
INSERT INTO SCHOOL (ADDRESS, DESCRIPTION, FAX, IS_PUBLIC, LOGO_URL, NAME, PHONE, WWW, CITY_ID, SCHOOL_TYPE_ID)
VALUES ('ulica1', 'opis1', 'fax1', TRUE, 'www.logo.pl1', 'Wyższa szkoła1', 'Phone 1', 'www.ws.pl1', 1, 2);
INSERT INTO SCHOOL (ADDRESS, DESCRIPTION, FAX, IS_PUBLIC, LOGO_URL, NAME, PHONE, WWW, CITY_ID, SCHOOL_TYPE_ID)
VALUES ('ulica2', 'opis2', 'fax2', TRUE, 'www.logo.pl2', 'Wyższa szkoła2', 'Phone 2', 'www.ws.pl2', 1, 2);
INSERT INTO SCHOOL (ADDRESS, DESCRIPTION, FAX, IS_PUBLIC, LOGO_URL, NAME, PHONE, WWW, CITY_ID, SCHOOL_TYPE_ID)
VALUES ('ulica3', 'opis3', 'fax3', TRUE, 'www.logo.pl3', 'Językowa szkoła3', 'Phone 3', 'www.ws.pl3', 1, 4);
INSERT INTO SCHOOL (ADDRESS, DESCRIPTION, FAX, IS_PUBLIC, LOGO_URL, NAME, PHONE, WWW, CITY_ID, SCHOOL_TYPE_ID)
VALUES ('ulica4', 'opis4', 'fax4', TRUE, 'www.logo.pl4', 'Językowa szkoła4', 'Phone 4', 'www.ws.pl4', 1, 4);
INSERT INTO SCHOOL (ADDRESS, DESCRIPTION, FAX, IS_PUBLIC, LOGO_URL, NAME, PHONE, WWW, CITY_ID, SCHOOL_TYPE_ID)
VALUES ('ulica5', 'opis5', 'fax5', TRUE, 'www.logo.pl5', 'Językowa szkoła5', 'Phone 5', 'www.ws.pl5', 2, 4);
